...
label = ttk.Label(hasil_row, text='Hasil')
label.grid(row=0, column=0,)
tombol = ttk.Button(hasil_row, text='tekan buat hasil')
...
status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
...
status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=6, column=0, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=6, column=1, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=6, column=2, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=6, column=3, padx=10, pady=5, sticky="ew")
...
status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=12, column=0, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=12, column=1, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=12, column=2, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=12, column=3, padx=10, pady=5, sticky="ew")

status_combobox = ttk.Combobox(complaint_row, values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=16, column=0, padx=10, pady=5, sticky="ew")

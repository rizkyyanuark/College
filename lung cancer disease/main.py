...
widgets_frame.place(x=20, y=20)
# widgets_frame1 = ttk.LabelFrame(frame1, text="Insert Row")
...
name_entry.place(x=20, y=20)

# name_entryp = ttk.Entry(widgets_frame1)
# name_entryp.insert(0, "Name")
# name_entryp.bind("<FocusIn>", lambda e: name_entry.delete('0', 'end'))
# name_entryp.grid(row=0, column=0, padx=5, pady=(0, 5), sticky="ew")

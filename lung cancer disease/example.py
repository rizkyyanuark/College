...
status_combobox = ttk.Combobox(
    tab_1, state='readonly', values=combo_list, width=10)
...
status_combobox = ttk.Combobox(
    tab_2, state='readonly', values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=1, column=0, padx=10, pady=5, sticky="ew")
...
status_combobox = ttk.Combobox(
    tab_3, state='readonly', values=combo_list, width=10)
status_combobox.current(0)
status_combobox.grid(row=1, column=0, padx=10, pady=5, sticky="ew")

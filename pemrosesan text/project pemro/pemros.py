...
def analyze_sentiment():
    ...
    messagebox.showinfo(
        "Analisis Sentimen", "Analisis sentimen akan dilakukan pada teks: " + text_to_analyze)
...
text_box = Text(root, height=12, width=55, bg="white",
...
clear_button = tk.Button(root, command=clear_text, image=image_trash,
...
start_button = tk.Button(root, command=recognize_speech, image=image_mic,
                         width=50, height=50, borderwidth=0, highlightthickness=0)
start_button.place(x=830, y=170)

# Membuat tombol untuk analisis sentimen
sentiment_button = tk.Button(root, text="Analisis Sentimen", command=analyze_sentiment, font=(

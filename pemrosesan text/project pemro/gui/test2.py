...
class App():
    def __init__(self, master):
        ...
        with Image.open(
                r'C:\Users\rizky\OneDrive\Dokumen\GitHub\test\testpython\pemrosesan text\project pemro\trash.png') as img:
        ...
        with Image.open(r'C:\Users\rizky\OneDrive\Dokumen\GitHub\test\testpython\pemrosesan text\project pemro\2176428.png') as img:
            mic_resize = img.resize((50, 50))
    ...
    def analyze_sentiment(self):
        loaded_vectorizer = joblib.load(
            r'C:\Users\rizky\OneDrive\Dokumen\GitHub\test\testpython\pemrosesan text\project pemro\bow_vectorizer.pkl')
        ...
        try:
            loaded_model = joblib.load(
                r'C:\Users\rizky\OneDrive\Dokumen\GitHub\test\testpython\pemrosesan text\project pemro\linear1000_model.pkl')
